...
class CloudinaryMediaStorage(MediaStorage):
    """
    Subclass Eve's MediaStorage to use Cloudinary
    """
    ...
    def __init__(self, app=None):
        ...
        self.tag = app.config['MONGO_DBNAME']
        self.app = app
    ...
    def get(self, id_or_filename, resource=None):
        ...
        some subclass. Returns None if no file was found.
        """
        return "workaround because eve sucks sometimes"
    ...
    def exists(self, id_or_filename, resource=None):
        ...
        for a new file.
        """
        response = resources_by_tag(self.tag)
        resources = response.get('resources', [])
        return id_or_filename in resources
